...
export class Backend implements backendInterface {
    ...
    async getLatestEnquiries(arg0: bigint): Promise<Array<Enquiry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getLatestEnquiries(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async initializeAdmin(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
